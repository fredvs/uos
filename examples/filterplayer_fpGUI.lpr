...
uses
  ...
  cthreads,  cwstring,
  {$ENDIF}{$ENDIF}
    SysUtils,uos, ctypes, Math,  Classes,fpg_button, fpg_edit, fpg_widget, fpg_label, fpg_Editbtn, fpg_RadioButton, fpg_trackbar, fpg_CheckBox, fpg_base, fpg_main, fpg_form
