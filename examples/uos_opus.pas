...
type
 ...
 opus_decoder_get_nb_samples: function(st: TOpusDecoder; const packet; len: Integer): Integer;
 opus_decoder_get_size: function(channels: Integer): Integer;
 opus_decoder_init: function(st: TOpusDecoder; Fs: Integer; channels: Integer): Integer;
 opus_packet_get_bandwidth: function(const packet): Integer;
 opus_packet_get_nb_channels: function(const packet): Integer;
 opus_packet_get_nb_frames: function(const packet; len: Integer): Integer;
 ...
 opus_packet_pad: function(var data; len, new_len: Integer): Integer;
 opus_packet_unpad: function(var data; len: Integer): Integer;
 opus_repacketizer_cat: function(rp: TOpusRepacketizer; const data; len: Integer): Integer;
 opus_repacketizer_create: function: TOpusRepacketizer;
 opus_repacketizer_destroy: procedure(rp: TOpusRepacketizer);
 opus_repacketizer_get_nb_frames: function(rp: TOpusRepacketizer): Integer;
 opus_repacketizer_get_size: function: Integer;
 opus_repacketizer_init: function(rp: TOpusRepacketizer): TOpusRepacketizer;
 ...
 opus_multistream_encoder_get_size: function(streams, coupled_streams: Integer): Integer;
 opus_multistream_encoder_init: function(st: TOpusMSEncoder; fs: Integer; channels, streams, coupled_streams: Integer; const mapping: array of Byte; application: Integer): Integer;

 opus_multistream_surround_encoder_create: function(Fs: Integer; channels, mapping_family, streams, coupled_streams: Integer; const mapping: array of Byte; application: Integer; out error: Integer): TOpusMSEncoder;
 opus_multistream_surround_encoder_get_size: function(channels, mapping_family: Integer): Integer;
 opus_multistream_surround_encoder_init: function(st: TOpusMSEncoder; fs: Integer; channels, mapping_family, streams, coupled_streams: Integer; const mapping: array of Byte; application: Integer): Integer;
