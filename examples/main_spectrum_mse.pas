...
uses
 ...
 msegraphics,msegraphutils,mseevent,mseclasses,msewidgets,mseforms, ctypes,
 msegraphedits,mseificomp,mseificompglob,mseifiglob,msescrollbar,mseact,
 msebitmap,msedataedits,msedatanodes,msedropdownlist,mseedit,msefiledialog,
 msegrids,mselistbrowser,msestatfile,msestream,msesys,sysutils,msesimplewidgets;
...
implementation
uses
 main_spectrum_mse_mfm, uos_flat;
