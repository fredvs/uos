...
function uos_AddFromFile(PlayerIndex: cint32; Filename: PChar; OutputIndex: cint32; SampleFormat:
...
function uos_AddIntoMemoryStream(PlayerIndex: cint32; Var MemoryStream: TMemoryStream; SampleRate:
                                 longint; SampleFormat: longint; Channels: longint; FramesCount:
...
function uos_AddFromMemoryBuffer(PlayerIndex: cint32; MemoryBuffer: TDArFloat; Bufferinfos:
                                 Tuos_bufferinfos; OutputIndex: cint32; FramesCount: cint32): cint32;
...
function uos_AddFromMemoryStream(PlayerIndex: cint32; Var MemoryStream: TMemoryStream; TypeAudio:
                                 cint32; OutputIndex: cint32; SampleFormat: cint32; FramesCount:
                                 cint32): cint32;
...
function uos_AddFromMemoryStreamDec(PlayerIndex: cint32; Var MemoryStream: TMemoryStream; Var
                                    Bufferinfos: Tuos_bufferinfos; OutputIndex: cint32; FramesCount:
                                    cint32): cint32;
...
// example : InputIndex1 := uos_AddFromFile(0, edit5.Text,-1,0,-1);  
 ...
 {$IF DEFINED(shout)}
function uos_AddIntoIceServer(PlayerIndex: cint32; SampleRate : cint; Channels: cint; SampleFormat:
                              cint;
...
function uos_AddIntoFile(PlayerIndex: cint32; Filename: PChar; SampleRate: cint32; Channels: cint32;
                         SampleFormat: cint32; FramesCount: cint32; FileFormat: cint32): cint32;
...
function uos_AddIntoFileFromMem(PlayerIndex: cint32; Filename: PChar; SampleRate: longint; Channels:
                                longint; SampleFormat: longint; FramesCount: longint; FileFormat:
                                cint32): longint;
...
function uos_InputAddDSPVolume(PlayerIndex: cint32; InputIndex: cint32; VolLeft: double; VolRight:
                               double): cint32;
// DSP Volume changer
// PlayerIndex : Index of a existing Player
// InputIndex : InputIndex of a existing Input
...
procedure uos_OutputAddDSPVolume(PlayerIndex: cint32; OutputIndex: cint32; VolLeft: double; VolRight
                                 : double);
// DSP Volume changer
// PlayerIndex : Index of a existing Player
...
procedure uos_InputSetDSPVolume(PlayerIndex: cint32; InputIndex: cint32; VolLeft: double; VolRight:
                                double; Enable: Boolean);
// InputIndex : InputIndex of a existing Input
// PlayerIndex : Index of a existing Player
// VolLeft : Left volume
// VolRight : Right volume
...
procedure uos_OutputSetDSPVolume(PlayerIndex: cint32; OutputIndex: cint32; VolLeft: double; VolRight
                                 : double; Enable: Boolean);
// OutputIndex : OutputIndex of a existing Output
// PlayerIndex : Index of a existing Player
// VolLeft : Left volume
...
function uos_InputAddDSP(PlayerIndex: cint32; InputIndex: cint32; BeforeFunc: TFunc; AfterFunc:
                         TFunc; EndedFunc: TFunc; Proc: TProc): cint32;
...
procedure uos_InputSetDSP(PlayerIndex: cint32; InputIndex: cint32; DSPinIndex: cint32; Enable:
                          Boolean);
// PlayerIndex : Index of a existing Player
// InputIndex : Input Index of a existing input
...
function uos_OutputAddDSP(PlayerIndex: cint32; OutputIndex: cint32; BeforeFunc: TFunc; AfterFunc:
                          TFunc; EndedFunc: TFunc; Proc: TProc): cint32;
...
procedure uos_OutputSetDSP(PlayerIndex: cint32; OutputIndex: cint32; DSPoutIndex: cint32; Enable:
                           Boolean);
// PlayerIndex : Index of a existing Player
// OutputIndex : OutputIndex of a existing Output
...
function uos_InputAddFilter(PlayerIndex: cint32; InputIndex: cint32; TypeFilterL: shortint;
                            LowFrequencyL, HighFrequencyL, GainL: cfloat; TypeFilterR: shortint;
                            LowFrequencyR, HighFrequencyR, GainR: cfloat;
...
procedure uos_InputSetFilter(PlayerIndex: cint32; InputIndex: cint32; FilterIndex: cint32;
                             ...
                             TypeFilterR: shortint;
                             LowFrequencyR, HighFrequencyR, GainR: cfloat; AlsoBuf: Boolean;
                             LoopProc: TProc; Enable: Boolean);
// InputIndex : InputIndex of a existing Input
...
function uos_OutputAddFilter(PlayerIndex: cint32; OutputIndex: cint32; TypeFilterL: shortint;
                             LowFrequencyL, HighFrequencyL, GainL: cfloat; TypeFilterR: shortint;
                             LowFrequencyR, HighFrequencyR, GainR: cfloat;
                             AlsoBuf: Boolean; LoopProc: TProc): cint32;
...
procedure uos_SetPluginGetBPM(PlayerIndex: cint32; PluginIndex: cint32; numofframes: integer; loop :
                              boolean;
                              Enable: boolean);
// PluginIndex : PluginIndex Index of a existing Plugin.  
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        begin
          uosPlayers[PlayerIndex].StreamIn[InputIndex].Data.DSPVolumeIndex := uosPlayers[PlayerIndex
                                                                              ].InputAddDSPVolume(
                                                                              InputIndex, VolLeft,
                                                                              VolRight);
...
begin
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        uosPlayers[PlayerIndex].StreamOut[OutputIndex].Data.DSPVolumeIndex := uosPlayers[PlayerIndex
                                                                              ].OutputAddDSPVolume(
                                                                              OutputIndex, VolLeft,
                                                                              VolRight);
end;
...
begin
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        uosPlayers[PlayerIndex].InputSetDSPVolume(InputIndex, uosPlayers[PlayerIndex].StreamIn[
                                                  InputIndex].Data.DSPVolumeIndex, VolLeft, VolRight
                                                  , Enable);
end;
// InputIndex : InputIndex of a existing Input
// PlayerIndex : Index of a existing Player
...
begin
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        uosPlayers[PlayerIndex].OutputSetDSPVolume(OutputIndex, uosPlayers[PlayerIndex].StreamOut[
                                                   OutputIndex].Data.DSPVolumeIndex, VolLeft,
                                                   VolRight, Enable);
end;
// OutputIndex : OutputIndex of a existing Output
// PlayerIndex : Index of a existing Player
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].InputAddDSP(InputIndex, BeforeFunc, AfterFunc, EndedFunc,
                  Proc);
end;
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].OutputAddDSP(OutputIndex, BeforeFunc, AfterFunc, EndedFunc
                  , Proc);
end;
    ...
    if  uosPlayersStat[PlayerIndex] = 1 then
      if assigned(uosPlayers[PlayerIndex]) then
        uosPlayers[PlayerIndex].InputSetSynth(InputIndex, WaveTypeL, WaveTypeR ,
                                              FrequencyL, FrequencyR, VolumeL, VolumeR, Duration,
                                              NbHarmonic, EvenHarmonics, Enable) ;
end;
{$endif}
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].AddIntoFile(Filename, SampleRate, Channels, SampleFormat,
                  FramesCount, FileFormat);
end;
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].AddIntoFileFromMem(Filename, SampleRate, Channels,
                  SampleFormat, FramesCount, FileFormat);
end;
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex +1 <= length(uosPlayers)) then
    if  uosPlayersStat[PlayerIndex] = 1 then
      if assigned(uosPlayers[PlayerIndex]) then
        Result :=  uosPlayers[PlayerIndex].AddIntoIceServer(SampleRate, Channels, SampleFormat,
                  EncodeType, Port,
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex +1 <= length(uosPlayers)) then
    if  uosPlayersStat[PlayerIndex] = 1 then
      if assigned(uosPlayers[PlayerIndex]) then
        Result :=  uosPlayers[PlayerIndex].AddIntoDevOut(Device, Latency, SampleRate, Channels,
                  SampleFormat , FramesCount, ChunkCount);
end;
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].AddFromFile(Filename, OutputIndex, SampleFormat,
                  FramesCount);
end;
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].AddIntoMemoryBuffer(outmemory, SampleRate, SampleFormat,
                  Channels, FramesCount);
end;
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].AddFromMemoryBuffer(MemoryBuffer, Bufferinfos, OutputIndex
                  , FramesCount);
end;
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].AddFromMemoryStream(MemoryStream, TypeAudio, OutputIndex,
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].AddFromMemoryStreamDec(MemoryStream, Bufferinfos,
                  OutputIndex, FramesCount);
end;
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
        Result := uosPlayers[PlayerIndex].AddFromFileIntoMemory(Filename, OutputIndex, SampleFormat,
                  FramesCount, numbuf);
end;
...
begin
  ...
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) and
     (length(uosPlayers[PlayerIndex].StreamIn) > 0) and (InputIndex + 1 <= length(uosPlayers[
     PlayerIndex].StreamIn)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
...
procedure uos_PlayNoFreePaused(PlayerIndex: cint32; nloop: integer = 0);
// Start playing paused but do not free the player after stop
begin
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
...
procedure uos_Stop(PlayerIndex: cint32);
// Stop playing and if uos_Play() was used: free the player
begin
  if (length(uosPlayers) > 0) and (PlayerIndex + 1 <= length(uosPlayers)) then
    if uosPlayersStat[PlayerIndex] = 1 then
      if Assigned(uosPlayers[PlayerIndex]) then
