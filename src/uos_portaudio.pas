...
// ****************** Miscellaneous utilities **************************
  ...
  ///////////////////////////////////////////////
    ...
    {$IFNDEF FPC}
    Pa_Handle:THandle=0; // this will hold our handle for the lib; it functions nicely as a mutli-lib prevention unit as well...
    {$else}
...
begin
   ...
   if Pa_Handle<>0 then begin
      ...
      {$IFNDEF FPC}
      if Pa_Handle <> 0 then begin {now we tie the functions to the VARs from above}
      ...
      {$else}
    	if Pa_Handle <> DynLibs.NilHandle then begin {now we tie the functions to the VARs from above}
