...
** On error all of these functions return -1.
 ...
 //the following CONST values originally are NOT in libsndfile.pas:
  const SEEK_SET  = 0;       //* seek relative to beginning of file */
  const SEEK_CUR  = 1;       //* seek relative to current file position */
  const SEEK_END  = 2;       //* seek relative to end of file */
  const SEEK_DATA = 3;       //* seek to the next data */
  const SEEK_HOLE = 4;       //* seek to the next hole */
  const SEEK_MAX = SEEK_HOLE;
var  sf_seek: function(sndfile : TSNDFILE_HANDLE; frame : Tsf_count_t; whence  : ctypes.cint):  Tsf_count_t ; cdecl;
...
var  sf_set_string: function(sndfile : TSNDFILE_HANDLE; str_type : ctypes.cint; str: ctypes.pcchar): ctypes.cint ; cdecl;
var  sf_get_string: function(sndfile : TSNDFILE_HANDLE; str_type : ctypes.cint): pChar ; cdecl;
var  sf_read_raw: function(sndfile : TSNDFILE_HANDLE; ptr : Pointer; bytes : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_write_raw: function(sndfile : TSNDFILE_HANDLE; ptr : Pointer; bytes : Tsf_count_t) : Tsf_count_t ; cdecl;
...
var  sf_writef_short: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcshort; frames  : Tsf_count_t) : Tsf_count_t ;cdecl;
var  sf_readf_int: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcint; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_writef_int: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcint; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_readf_float: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcfloat; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_writef_float: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcfloat; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_readf_double: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcdouble; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_writef_double: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcdouble; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
...
var  sf_read_short: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcshort; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_write_short: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcshort; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_read_int: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcint; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_write_int: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcint; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_read_float: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcfloat; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_write_float: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcfloat; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
var  sf_read_double: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcdouble; frames  : Tsf_count_t) : Tsf_count_t ;cdecl;
var  sf_write_double: function(sndfile : TSNDFILE_HANDLE; ptr : ctypes.pcdouble; frames  : Tsf_count_t) : Tsf_count_t ; cdecl;
...
var  sf_close: function(sndfile : TSNDFILE_HANDLE) : ctypes.cint ; cdecl;
...
var  sf_write_sync: function(sndfile : TSNDFILE_HANDLE)  : ctypes.cint ; cdecl;
